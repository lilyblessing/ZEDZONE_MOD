...
# MOD 3：便携小冰箱 (PortableFridge) v0.3.3
...
- NoteTag v0.5.5 —— 命名牌：注册/配方/贴图/拖放/持久化/tooltip 展示/性能优化/中英双语
- BigFridge v0.2.3 —— 大容量冰箱：22x34 扩容/旧存档迁移/低频守护轮询
- PortableFridge v0.3.3 —— 便携小冰箱：内置容器/电瓶供电/食物保鲜/性能优化/中英双语
