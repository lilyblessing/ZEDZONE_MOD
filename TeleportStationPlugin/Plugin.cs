...
/// </summary>
[BepInPlugin("com.zedzone.teleportstation", "TeleportStation", "0.9.54")]
...
//   SelectItem(private) patch 甚至破坏了点击流程（回滚）；详情大图标单独再议
        ...
        Log.LogInfo("[TeleportStation] v0.9.54 P6.11 delegate target hijack: patch <>c.b__0_0 fallback + TryCreateDelegate via Activator/Il2Cpp for InteractDelegate, Q preserved");
    }
}
