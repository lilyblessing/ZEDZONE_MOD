...
/// </summary>
[BepInPlugin("com.zedzone.teleportstation", "TeleportStation", "0.9.50")]
...
//   SelectItem(private) patch 甚至破坏了点击流程（回滚）；详情大图标单独再议
        ...
        Log.LogInfo("[TeleportStation] v0.9.50 P6.9 原生化重构：外部单F/Q原生(文本微调为传送控制台)+内部 ComputerPanel 三项原生替换(重命名/选点/退出)，P6.9 delegate hijack内部菜单+静默TypeByName根治日志风暴 移除0.5s轮询与重复Add，根治帧数骤降与刷屏");
    }
}
