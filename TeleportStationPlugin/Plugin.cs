...
/// </summary>
[BepInPlugin("com.zedzone.teleportstation", "TeleportStation", "0.9.53")]
...
//   SelectItem(private) patch 甚至破坏了点击流程（回滚）；详情大图标单独再议
        ...
        Log.LogInfo("[TeleportStation] v0.9.53 P6.9 delegate fix: fieldType fallback for InteractDelegate (Type must derive from Delegate), hijack all F, preserve Q, NRE 0");
    }
}
