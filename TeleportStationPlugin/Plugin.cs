...
/// </summary>
[BepInPlugin("com.zedzone.teleportstation", "TeleportStation", "0.9.36")]
...
//   SelectItem(private) patch 甚至破坏了点击流程（回滚）；详情大图标单独再议
        ...
        Log.LogInfo("[TeleportStation] v0.9.36 P5 修复 供电严格+电池 GetBatteryRemainingPower/ChargeBattery");
    }
}
