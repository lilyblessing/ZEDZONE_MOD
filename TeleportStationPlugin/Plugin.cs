...
/// </summary>
[BepInPlugin("com.zedzone.teleportstation", "TeleportStation", "0.9.55")]
...
//   SelectItem(private) patch 甚至破坏了点击流程（回滚）；详情大图标单独再议
        ...
        Log.LogInfo("[TeleportStation] v0.9.55 P6.11 hotfix: disable Activator delegate (crash) + fix <>c nested lookup via GetNestedType, delegate preserved relies on <>c prefix");
    }
}
